...
_THINK_TEMPLATE = """Write your plan in markdown todo format.
Write actions that I can execute immediately, without the need to complete any other actions first.
